...
## Notes
The most challenging part was implementing the tip slider. The slider becomes visible when the switch in the navigation bar on and the segment control becomes hidden. Implementing this mechanism while keeping the tip calculater function based on the state (slider or segment control) proved to be a challenging task.
